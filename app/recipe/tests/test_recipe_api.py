...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrieve_recipes_successful(self):
    ...
    def test_get_recipe_detail(self):
        """Test get recipe detail successful."""
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        brown_rice = Ingredient.objects.create(
            user=self.user, name='Brown Rice')
        ...
        recipe = recipes[0]
        self.assertEqual(recipe.ingredients.count(), 2)
        self.assertIn(brown_rice, recipe.ingredients.all())
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Vegetable Thai Curry')
